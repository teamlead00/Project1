...
public class DynamicSuiteGenerator {
    public static void GenerateSuite() throws Exception {
        ...
        suite.setName("CRM Test Suite");
        suite.addListener("CRM.Utils.ReportListener");
    ...
    private static List<XmlClass> FilterXmlClasse(String moduleName, List<String> tetsIds) {
        String packageName = "CRM.Tests."+moduleName;
    ...
    private static void writeSuiteToFile(XmlSuite suite) {
        String xmlpath = System.getProperty("user.dir") + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "suite-xml-files" + File.separator + "CRM Test Suite.xml";
    ...
    private static void writeMultipleSuiteToFile(XmlSuite suite) {
        ...
        String xmlpath = System.getProperty("user.dir") + File.separator + "src" + File.separator + "test" + File.separator + "resources" + File.separator + "dynamic_suites_xml_files" + File.separator + "CRM Test Suite"+count+".xml";
