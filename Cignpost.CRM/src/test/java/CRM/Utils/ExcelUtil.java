    ...
    public synchronized static void GetUserData() throws Exception {
        ...
        try {
            ...
            while (recordset.next()) {
                ...
                if (recordset.getField("UserType").equalsIgnoreCase("UserLogin")) {
                    //Get data from Excel
                    Urls.baseUrl = recordset.getField("UserURL");
                ...
                }if (recordset.getField("UserType").equalsIgnoreCase("SuperAdmin")) {
                    Urls.baseUrl = recordset.getField("UserURL");

                    Start.currentBrowser = recordset.getField("Browser");
                    GlobalTestData.SuperAdmin_Users.setUserId(recordset.getField("UserName"));
                    GlobalTestData.SuperAdmin_Users.setPassword(recordset.getField("Password"));
                    GlobalTestData.SuperAdmin_Users.setUserURL(recordset.getField("UserURL"));
                }
                if (recordset.getField("UserType").equalsIgnoreCase("MemberLogin")){
                    Urls.baseUrl = recordset.getField("UserURL");

                    Start.currentBrowser = recordset.getField("Browser");
                    GlobalTestData.MemberLogin_Users.setUserId(recordset.getField("UserName"));
                    GlobalTestData.MemberLogin_Users.setPassword(recordset.getField("Password"));
                    GlobalTestData.MemberLogin_Users.setUserURL(recordset.getField("UserURL"));
                }
                if (recordset.getField("UserType").equalsIgnoreCase("InvalidUser")){
                    Urls.baseUrl = recordset.getField("UserURL");

                    Start.currentBrowser = recordset.getField("Browser");
                    GlobalTestData.InvalidUser_Users.setUserId(recordset.getField("UserName"));
                    GlobalTestData.InvalidUser_Users.setPassword(recordset.getField("Password"));
                    GlobalTestData.InvalidUser_Users.setUserURL(recordset.getField("UserURL"));
                }
...
//            System.out.println("=============================");
            ...
            for (Map<String, String> module : lstModules) {
                //Hold Single Test S_Configuration
                ...
                //Add Single Test S_Configuration into List
