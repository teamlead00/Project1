...
import static CRM.Utils.Common.GetUserData;
import static CRM.Utils.ReportUtil.getTest;

@Listeners({TestEvents.class, SuiteEvents.class})

public class TestBase {

    public static String ePath = "D:\\CRM\\Cignpost.CRM\\src\\test\\resources\\TestData\\UserData.xls";
    public static String sheet = "User_TestData";
    public static String sheet_SuperAdmin = "SuperAdmin_TestData";
    public static String sheet_Member = "Member_TestData";
    public static String sheet_end2End = "EndToEnd_TestData";
